...
import com.bofigo.rowmaterial.domain.service.rawmaterialcategory.RawMaterialCategoryService;
...
public class RawMaterialCategoryController {
	...
	private static Logger logger = LoggerFactory.getLogger(RawMaterialCategoryController.class);
